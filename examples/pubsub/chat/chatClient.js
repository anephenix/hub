...
class ChatClient {
    ...
    async join (channel) {
        try {
            ...
            this.client.addChannelMessageHandler(this.channel, this.messageAttachFunction);
        } catch (error) {
            console.error(error);
        }
    }
    ...
    leave() {
        try {
            ...
            this.client.removeChannelMessageHandler(this.channel, this.messageAttachFunction);
        } catch (error) {
            console.error(error);
        }
    }
